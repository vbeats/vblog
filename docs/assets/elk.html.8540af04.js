import{e as n}from"./app.e2a16f3a.js";import{_ as s}from"./plugin-vue_export-helper.21dcd24c.js";const a={},p=n(`<h1 id="elk" tabindex="-1"><a class="header-anchor" href="#elk" aria-hidden="true">#</a> ELK</h1><h2 id="\u5185\u6838\u53C2\u6570\u4FEE\u6539" tabindex="-1"><a class="header-anchor" href="#\u5185\u6838\u53C2\u6570\u4FEE\u6539" aria-hidden="true">#</a> \u5185\u6838\u53C2\u6570\u4FEE\u6539</h2><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code>/etc/sysctl.conf  <span class="token comment">#vm.max_map_count=262144</span>
sysctl -p
