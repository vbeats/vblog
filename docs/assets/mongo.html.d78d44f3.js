import{e as n}from"./app.8f9c3ce2.js";import{_ as s}from"./plugin-vue_export-helper.21dcd24c.js";const a={},p=n(`<h1 id="mongo" tabindex="-1"><a class="header-anchor" href="#mongo" aria-hidden="true">#</a> Mongo</h1><p><code>aggregate</code>: \u805A\u5408</p><div class="language-bash ext-sh line-numbers-mode"><pre class="language-bash"><code>db.doc.aggregate<span class="token punctuation">(</span><span class="token punctuation">[</span> <span class="token comment"># pipline \u7BA1\u9053\u5904\u7406</span>
